...
%             end
%         end
% %         if and(abs(Y1+sqrt(3)*X1-sqrt(3)*4) < delta, abs(Y2+sqrt(3)*X2-sqrt(3)*4) < delta)
% %             plot(X1,Y1,'ro')
% %             plot(X2,Y2,'ro')
% %         end
%     end
...
%     for i = 1:n
%     for j=1:3
%         plot(X(four1(i,1)),Y(four1(i,1)),'r*')
%         plot(X(four1(i,2)),Y(four1(i,2)),'g*')
%         plot(X(four1(i,3)),Y(four1(i,3)),'b*')
%         plot(X(four1(i,4)),Y(four1(i,4)),'y*')
%     end
%     end
